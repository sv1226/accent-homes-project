...
?>
		 ...
		 <div class="content">
		 	...
		 	<div class="gallerys">
		 		<div class="wrap">
					<h3>Flats for Rent</h3>
					<div class="gallery-grids">
					<?php 
					$select= "select* from sale where type='rent' and category='flats'";
					...
					while($res=mysqli_fetch_array($data)){ ?>
						<div class="gallery-grid">
							...
							<div class="gallery-button"><a href="purchaseform.php?q=<?php echo $res[0]?>">Contact</a></div>
						</div>
				<?php } ?>		
