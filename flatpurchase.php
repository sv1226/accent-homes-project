...
?>
		 ...
		 <div class="content">
		 	...
		 	<div class="gallerys">
		 		<div class="wrap">
					<h3>Flats for sale</h3>
					<div class="gallery-grids">
					<?php 
					$select= "select* from sale where type='sale' and category='flats'";
					$data=mysqli_query($conn,$select);
					
					while($res=mysqli_fetch_array($data)){ ?>
						<div class="gallery-grid">
							<a href="<?php echo $res[11]; ?>"><img src="<?php echo $res[11]; ?>" alt=""></a>
							<h4><?php echo $res[1] ?></h4>
							<p>See List of flat types for a complete listing of housing types and layouts, real estate trends for shifts in the market and house or home for more general information.</p>
							<div class="gallery-button"><a href="purchaseform.php?q=<?php echo $res[0]; ?>">Purchase Now</a></div>
						</div>
				<?php } ?>		
