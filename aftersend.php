<?php include 'header.php'; ?>
	...
	<!--start-image-slider---->
		 ...
		 <!-- 	<div class="top-grids">
		 		<div class="wrap">
			 		<div class="top-grid">
			 			<a href="sale.php"><img src="images/icon1.png" title="icon-name"></a>
			 			<h3>Sales</h3>
			 			<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
			 			<a class="button" href="first.php?q=sale">More Info</a>
			 		</div>
			 		<div class="top-grid">
			 			<a href="#"><img src="images/icon2.png" title="icon-name"></a>
			 			<h3>Purchase</h3>
			 			<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.  </p>
			 			<a class="button" href="purchasefirst.php?q=purchase">More Info</a>
			 		</div>
			 		<div class="top-grid last-topgrid">
			 			<a href="#"><img src="images/icon3.png" title="icon-name"></a>
			 			<h3>Rent</h3>
			 			<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor i0ncididunt ut labore et dolore magna aliqua. </p>
			 			<a class="button" href="rentfirst.php?q=rent">More Info</a>
			 		</div> -->
			 		<div class="clear"> </div>
		 		</div>
		 	</div>
