		 ...
		 <div class="content">
		 	...
		 	<div class="gallerys">
		 		<div class="wrap">
					...
					<?php 
					$select= "select * from sale where category='land' and type='sale'";
					...
					while($res=mysqli_fetch_array($data)){ ?>
						<div class="gallery-grid">
							...
							<p>A. Land qualities affecting primary productivity The land qualities in this category include availability of moisture, nutrients and oxygen, and susceptibility to soil erosion. .</p>
